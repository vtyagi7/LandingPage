...
const Register = () => {
  ...
  return (
    <div className="flex w-screen h-screen">
      ...
      <div className=" w-1/2 bg-[#E97451]/50 bg-gradient-to-br from-[#E97451]/50 via-[#EE9176]/50 to-[#EEDAAB] flex flex-col items-center justify-center gap-4">
        ...
        <div className='mt-16 lg:w-[500px] lg:h-[650px] md:w-[450px] md:h-[450]  sm:w-[400px] xs:w-[200px] backdrop-blur-sm '>
          <div  className='flex flex-col items-center gap-4'>
            <text className=' font-playfair bold-48   text-[#000]'>Register as Retailer</text>
            <p className=" text-[16px] font-[400] leading-none font-opensans text-gray-800 text-center">Website version is only available for retailers currently. Please use the Android app to connect with your favorite retailers.</p>
          </div>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col'>
                  ...
                  <div className="font-opensans regular-18">
                    ...
                    <input
                      ...
                      className=" placeholder-gray-700 w-full py-3 text-gray-800 bg-transparent border-b border-gray-950 "
                    />
                  </div>
                  <div className="font-opensans regular-18">
                    <input
                ...
                <div className='flex items-center justify-center regular-16 font-opensans mt-6 gap-2'>
                  <div className=''>
